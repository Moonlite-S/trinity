    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_amount', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('project_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='invoices', to='Trinity_Project.project')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('role', models.CharField(choices=[('Manager', 'Manager'), ('Team Member', 'Team Member'), ('Administrator', 'Administrator'), ('Accountant', 'Accountant')], default='Team Member', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_edited_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='edited_submittals', to=settings.AUTH_USER_MODEL)),
