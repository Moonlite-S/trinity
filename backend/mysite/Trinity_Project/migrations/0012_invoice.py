...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Trinity_Project', '0011_alter_rfi_description_alter_rfi_notes_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            name='Invoice',
            fields=[
                ('invoice_id', models.CharField(max_length=20, primary_key=True, serialize=False, unique=True)),
